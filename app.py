...
from modules.dashboard_carbon_trend import router as dashboard_carbon_trend_router
...
from modules.process_device_top10 import router as process_device_top10_router
...
from modules.process_outer_supply_pump_info import router as process_outer_supply_pump_info_router
...
app.include_router(dashboard_carbon_trend_router)
...
app.include_router(process_device_top10_router)
